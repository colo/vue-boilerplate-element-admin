...
/* Layout */
import Layout from '@vue-element-admin/layout'
...
export const constantRoutes = [
...

  {
    ...
    children: [{
      path: 'dashboard',
      name: 'Dashboard',
      component: () => import('@vue-element-admin/views/dashboard/index'),
    ...
    children: [
      {
        path: 'index',
        name: 'Form',
        component: () => import('@vue-element-admin/views/form/index'),
