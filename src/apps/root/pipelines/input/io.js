...
const debug = Debug("apps:root:pipelines:input:io")

// debug_internals = Debug("mngr-ui:apps:root:pipelines:input:io:Internals"),
// debug_events = Debug("mngr-ui:apps:root:pipelines:input:io:Events");
